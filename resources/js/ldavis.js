LDAvis = function(to_select, json_file) {
    ...
    color1 = "#85A782", // baseline color for default topic circles and overall term frequencies
    color2 = "#663399"; // 'highlight' color for selected topics and term-topic frequencies
